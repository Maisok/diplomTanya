          ...
          <div class="flex flex-col md:flex-row items-center gap-6">
            ...
            <div class="relative">
              <img 
                ...
                data-full-image="{{asset('storage/' . $specialist->image)}}"
              >
            ...
            <div class="flex-grow text-center md:text-left">
              <h2 class="text-2xl font-bold">
                {{ $specialist->last_name }} {{ $specialist->first_name }} {{ $specialist->middle_name }}
              </h2>
              ...
              @if($specialist->average_rating)
                <div class="flex items-center justify-center md:justify-start">
                  <div class="flex mr-2">
                    @for($i = 1; $i <= 5; $i++)
                      <svg class="w-5 h-5 rating-star {{ $i <= round($specialist->average_rating) ? 'text-yellow-400' : 'text-gray-500' }}" fill="currentColor" viewBox="0 0 20 20">
